...
declare_id!("FlashArb11111111111111111111111111111111");
...
pub mod flash_arbitrage {
    ...
    pub fn execute_flash_arbitrage(
        ...
        require!(flash_loan_amount <= 1_000_000_000_000, FlashArbitrageError::AmountTooLarge);
        ...
        let flash_loan_result = execute_flash_loan(
        ...
        require!(final_balance >= repay_amount, FlashArbitrageError::InsufficientFunds);
        
        let gross_profit = final_balance - repay_amount;
        require!(gross_profit >= min_profit, FlashArbitrageError::ProfitTooLow);
    ...
    pub fn withdraw_fees(
        ...
        require!(amount <= available_balance, FlashArbitrageError::InsufficientFunds);
...
fn calculate_min_output(input: u64, expected: u64, max_slippage_bps: u16) -> u64 {
